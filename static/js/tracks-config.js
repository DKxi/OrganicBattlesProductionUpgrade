...
const TRACKS = [
  ...
  // 12 Advanced Mechanistic Mastery Tracks
  {
    ...
    boss: 'The Lexicon',
    boss_folder: 'https://aamwrwbsrmorllisdffc.supabase.co/storage/v1/object/public/AdvancedBosses',
    questions: 1350,
    chapters: 27,
    accent: 'violet',
  ...
  // 7 Foundational Open Tracks
  {
    ...
    boss: 'The Namer',
    boss_folder: 'https://aamwrwbsrmorllisdffc.supabase.co/storage/v1/object/public/FoundationalBosses',
    questions: 1550,
    chapters: 31,
    accent: 'sky',
